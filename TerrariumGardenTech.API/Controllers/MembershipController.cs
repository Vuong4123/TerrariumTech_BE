...
namespace TerrariumGardenTech.API.Controllers
{
    ...
    public class MembershipController : ControllerBase
    {
        ...
        public MembershipController(IMembershipService membershipService, IMembershipPackageService membershipPackageService)
        {
        ...
        public async Task<IBusinessResult> PurchaseMembership([FromBody] CreateMembershipRequest request)
        {
            try
            {
                ...
                var package = await _membershipPackageService.GetByIdAsync(request.PackageId);  // Dùng _membershipPackageService
                if (package == null)
                ...
                return new BusinessResult(Const.SUCCESS_CREATE_CODE, "Tạo membership cho người dùng thành công", membershipId);
            }
