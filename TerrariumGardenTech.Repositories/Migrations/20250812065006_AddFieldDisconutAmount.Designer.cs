...
namespace TerrariumGardenTech.Repositories.Migrations
{
    ...
    [Migration("20250812065006_AddFieldDisconutAmount")]
    partial class AddFieldDisconutAmount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TerrariumGardenTech.Common.Entity.CartItem", b =>
                {
                    ...
                    b.Property<int?>("TerrariumVariantQuantity")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TerrariumGardenTech.Common.Entity.Favorite", b =>
                {
            ...
            modelBuilder.Entity("TerrariumGardenTech.Common.Entity.MembershipPackage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TerrariumGardenTech.Common.Entity.OrderRequestRefund", b =>
                {
                    ...
                    b.HasKey("RequestRefundId")
                        .HasName("PK_OrderRequestRefund");

                    b.HasIndex("OrderId");

                    b.ToTable("OrderRequestRefund", (string)null);
                });
            ...
            modelBuilder.Entity("TerrariumGardenTech.Common.Entity.OrderTransport", b =>
                {
                    ...
                    b.Property<int>("ContactFailNumber")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("EstimateCompletedDate")
                        .HasColumnType("datetime2");

                    b.Property<bool>("IsRefund")
                        .HasColumnType("bit");

                    b.Property<DateTime?>("LastConfirmFailed")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("TerrariumGardenTech.Repositories.Entity.Payment", b =>
                {
            ...
            modelBuilder.Entity("TerrariumGardenTech.Common.Entity.CartItem", b =>
                {
                    ...
                    b.HasOne("TerrariumGardenTech.Common.Entity.Cart", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("TerrariumGardenTech.Common.Entity.TransportLog", b =>
                {
                    b.HasOne("TerrariumGardenTech.Common.Entity.OrderTransport", "Transport")
            ...
            modelBuilder.Entity("TerrariumGardenTech.Repositories.Entity.Membership", b =>
                {
                    b.HasOne("TerrariumGardenTech.Common.Entity.MembershipPackage", "Package")
            ...
            modelBuilder.Entity("TerrariumGardenTech.Repositories.Entity.Order", b =>
                {
                    b.HasOne("TerrariumGardenTech.Repositories.Entity.Address", "Address")
                        .WithMany()
            ...
            modelBuilder.Entity("TerrariumGardenTech.Repositories.Entity.Personalize", b =>
                {
                    ...
                    b.HasOne("TerrariumGardenTech.Common.Entity.Shape", "Shapes")
                        .WithMany()
                        .HasForeignKey("ShapeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TerrariumGardenTech.Common.Entity.TankMethod", "TankMethods")
                        .WithMany()
