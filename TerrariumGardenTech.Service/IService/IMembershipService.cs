...
namespace TerrariumGardenTech.Service.IService
{
    ...
    {
        Task<int> CreateMembershipAsync(string membershipType, DateTime startDate);
        ...
        Task<bool> UpdateMembershipAsync(int membershipId, string membershipType, DateTime startDate);
